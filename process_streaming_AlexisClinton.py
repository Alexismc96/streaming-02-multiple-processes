...
input_file = open("nyc_temperature.csv", "r")
...
for row in reader:
    ...
    date,tmax,tmin,tavg,departure,HDD,CDD,precipitation,new_snow,snow_depth = row
    
    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"[{date}, {tmax}, {tmin}, {tavg}, {departure}, {HDD}, {CDD}, {precipitation}, {new_snow}, {snow_depth}]"
